...
#define CONFIG_SYS_ASCDISP_ADDR	IOADDR(0x0D040000) 	/* Display controller regs */
...
#define CONFIG_SYS_FLASH_SIZE		0x400000	/* flash size 4MB */
#define CONFIG_SYS_FLASH_SECT_SZ	0x10000		/* primary   block size 64KB */
